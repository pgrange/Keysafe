...
class AttestationIdsRepository {
     ...
     */
    func getAttestationId(attestationIndex: UInt32) throws -> secp256k1.Signing.PrivateKey {
        ...
        let attestationId = try derivator.privateKey(privateParentKey: index, index: 1)
        return try secp256k1.Signing.PrivateKey(dataRepresentation: attestationId.key)
    }
